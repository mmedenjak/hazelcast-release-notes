...
- **Hazelcast for OpenShift and CloudFoundry**: Hazelcast members on OpenShift and CloudFoundry can discover each other. Please refer to [Hazelcast OpenShift](https://hub.docker.com/r/hazelcast/openshift/) and [Hazelcast CloudFoundry](https://github.com/hazelcast/hazelcast-cloudfoundry).
- **Apache Spark Connector:** A plugin which allows Hazelcast maps and caches to be used as shared RDD caches by Spark using the Spark RDD API. Please refer to the plugin's repo at [Spark Connector for Hazelcast](https://github.com/hazelcast/hazelcast-spark).
