...
This section lists the new features, enhancements and fixed issues for 3.6-EA (Early Access) release.

## New Features

The following are the new features introduced with 3.6-EA (Early Access) release.
