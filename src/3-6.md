...
The following are the the enhancements introduced with 3.6-EA (Early Access) release.
...
The following are the issues solved for Hazelcast 3.6 and 3.6.x releases.
...
- Descriptions of some maximum size policies defined in the `com.hazelcast.config.EvictionConfig.MaxSizePolicy` and `com.hazelcast.config.MaxSizeConfig.MaxSizePolicy` are not clear and confusing. They shoule be clarified. <a href="https://github.com/hazelcast/hazelcast/issues/7267" target="_blank">[7267]</a>
...
This section lists the enhancements and fixed issues for 3.6-RC1 release.
