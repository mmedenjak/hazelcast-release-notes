...
* Moved the Ringbuffer classes from the `com.hazelcast.core`
package to `com.hazelcast.ringbuffer`.
https://github.com/hazelcast/hazelcast/pull/15121[#15121]
* Moved the `Operation` interface in the `com.hazelcast.spi`
package to `com.hazelcast.spi.impl.operationservice`.
https://github.com/hazelcast/hazelcast/pull/15115[#15115]
* Moved the partition SPI classes to the
`com.hazelcast.spi.partition` package.
...
+
* Moved the partition related classes in the `com.hazelcast.core` package
to `com.hazelcast.partition`.
...
* Moved the `OperationService` from the `com.hazelcast.spi` package
to `com.hazelcast.spi.impl`.
https://github.com/hazelcast/hazelcast/pull/14969[#14969]
...
https://github.com/hazelcast/hazelcast/pull/14956
