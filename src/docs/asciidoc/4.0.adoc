...
NOTE: See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#upgrading-to-hazelcast-imdg-4-0[Hazelcast IMDG 4.0 Migration Guide^]
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/index.html#using-persistent-memory[Using Persistent Memory section^].
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#encryption-at-rest[Encryption at Rest section^].
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#tls-authentication-type[Security chapter^].
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#ldap-authentication-type[Security chapter^].
* **CP Subsystem Persistence:** Implemented persistency for Hazelcast's
CP (Consistency & Partition Tolerance) subsystem. 
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#cp-subsystem-persistence[CP Subsystem Persistence section^].
...
or two members. See the https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#cp-subsystem-unsafe-mode[CP Subsystem Unsafe Mode section].
...
+
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/index.html#defining-wan-replication[Defining WAN Replication section^]
...
+
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#jaas-authentication[JAAS Authentication section^]
...
+
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#changes-in-the-security-configuration[Hazelcast IMDG 4.0 Migration Guide^]
and link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#security[Security chapter^].
* **Javadoc for the Hazelcast IMDG Enterprise Edition:** Added Javadoc JAR file
for the Hazelcast IMDG Enterprise Edition.
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#getting-started[Getting Started section^]
...
using HTTP. See the
link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#using-the-script-cluster-sh[cluster.sh^] and
link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#health-check-script[healtcheck.sh^] sections.
...
https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/index.html#loading-and-storing-persistent-data[Loading and Storing Persistent Data section].
* **Moby Naming:** Introduced friendly names for the Hazelcast instances to be shown
in the Hazelcast Management Center. See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#checking-the-name-of-the-instance-for-rest-client[Checking the Instances' Name section^]. Also, a new system property, `hazelcast.member.naming.moby.enabled`, is introduced for this purpose.
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#configuring-backup-acknowledgment[Configuring Backup Acknowledgment section^].
...
+
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#client-system-properties[Client System Properties section^].
...
NOTE: Please see the link:https://docs.hazelcast.org/docs/4.0-BETA-2/manual/html-single/#upgrading-to-hazelcast-imdg-4-0[Upgrading to Hazelcast IMDG 4.0^] for the details of following breaking changes to be considered while upgrading to IMDG 4.0. 
