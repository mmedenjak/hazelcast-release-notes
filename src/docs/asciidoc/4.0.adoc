...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-1/manual/html-single/index.html#???[??? section^].
* **Security Audit Logging:** Introduced an API layer which
allows processing auditable event streams.
See the link:https://docs.hazelcast.org/docs/4.0-BETA-1/manual/html-single/index.html#???[??? section^].
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-1/manual/html-single/index.html#???[???^].
...
or two members. See the https://docs.hazelcast.org/docs/4.0-BETA-1/manual/html-single/index.html#???[??? section].
* **CP Subsystem Persistence:** Implemented persistent for Hazelcast's
...
+
See the link:https://docs.hazelcast.org/docs/4.0-BETA-1/manual/html-single/index.html#???[??? section^].
* **Javadoc for the Hazelcast IMDG Enterprise Edition:** Produced Javadoc JAR file
...
See the https://docs.hazelcast.org/docs/4.0-BETA-1/manual/html-single/#jcache-111[Upgrading to JCache 1.1.1 section].
...
* **Boomerang Backups:** Introduced a way to eliminate the sync backup
...
* Removed the `ILock` and `ICondition` interfaces, and their
implementations. The `ILock implementation is still being kept
