...
eviction policy. Please refer to the Custom Eviction Policy section.
...
this implementation as a plugin to your projects. Please refer to
Hazelcast-Azure plugin page.
...
force start using shell scripting. Please refer to Hazelcast CLI plugin
page.
...
Hazelcast OpenShift and Hazelcast CloudFoundry plugin pages.
...
dropped for any reason, realignment is attained. Please refer to the
Synchronizing WAN Target Cluster section.
...
member goes down. Please refer to the Durable Executor Service section.
...
to the
http://docs.hazelcast.org/docs/3.7/manual/html-single/index.html#phone-home[Phone
Home section].
...
the
http://docs.hazelcast.org/docs/3.7/manual/html-single/index.html#jcache-hazelcast-instance-integration[JCache
- Hazelcast Instance Integration section].
