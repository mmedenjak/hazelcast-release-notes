...
- **Fault Tolerant Executor Service:** An executor task (`Runnable` or `Callable`) stores the intermediate state. In the event of failover, computation continues on another member.
