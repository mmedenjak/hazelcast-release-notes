...
- **Cluster Split-Brain Protection for Queue and Lock**: Split-brain protection is now available for the queue and lock data structures. Please refer to the sections <a href="http://docs.hazelcast.org/docs/3.8-EA/manual/html-single/index.html#lock-split-brain-protection" target="_blank">Lock Split-Brain Protection</a> and <a href="http://docs.hazelcast.org/docs/3.8-EA/manual/html-single/index.html#queue-split-brain-protection" target="_blank">Queue Split-Brain Protection</a>.
